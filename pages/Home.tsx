            ...
            <div className="max-w-7xl mx-auto px-6 py-20 relative z-10">
                ...
                <div className="flex overflow-x-auto md:grid md:grid-cols-3 gap-6 pb-8 snap-x snap-mandatory scrollbar-hide -mx-6 px-6 md:mx-0 md:px-0">
                    ...
                    <Link to="/chefos" className="group relative flex-shrink-0 w-[85vw] md:w-auto snap-center">
                        ...
                        <div className="relative h-full bg-slate-900/40 backdrop-blur-xl border border-white/10 rounded-2xl p-8 hover:border-blue-500/30 transition-all duration-300 flex flex-col overflow-hidden">
                            ...
                            <div className="mt-auto">
                                <h3 className="text-2xl font-bold text-white mb-2 group-hover:text-blue-400 transition-colors">ChefOS</h3>
                    ...
                    <Link to="/siteos" className="group relative flex-shrink-0 w-[85vw] md:w-auto snap-center">
                        ...
                        <div className="relative h-full bg-slate-900/40 backdrop-blur-xl border border-white/10 rounded-2xl p-8 hover:border-indigo-500/30 transition-all duration-300 flex flex-col overflow-hidden">
                            <div className="absolute top-0 right-0 p-4 opacity-50">
                            ...
                            <div className="mt-auto">
                                <h3 className="text-2xl font-bold text-white mb-2 group-hover:text-indigo-400 transition-colors">SiteOS</h3>
                                <p className="text-sm text-slate-400 mb-6 leading-relaxed">
                    ...
                    <Link to="/logistics" className="group relative flex-shrink-0 w-[85vw] md:w-auto snap-center">
                        ...
                        <div className="relative h-full bg-slate-900/40 backdrop-blur-xl border border-white/10 rounded-2xl p-8 hover:border-emerald-500/30 transition-all duration-300 flex flex-col overflow-hidden">
                            <div className="absolute top-0 right-0 p-4 opacity-50">
                            ...
                            <div className="mt-auto">
                                <h3 className="text-2xl font-bold text-white mb-2 group-hover:text-emerald-400 transition-colors">Aegis</h3>
                                <p className="text-sm text-slate-400 mb-6 leading-relaxed">
